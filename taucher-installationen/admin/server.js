...
const WEBROOT = '/var/www/taucher-installationen';
...
// ── Basic Auth ──────────────────────────────────────────────────────────────
app.use(basicAuth({
  users: { 'admin': 'Taucher2026!' },
  challenge: true,
  realm: 'Taucher Installationen Admin'
}));
...
app.listen(PORT, '127.0.0.1', () => {
  console.log(`✓ Taucher Admin Panel: http://127.0.0.1:${PORT}/panel.html`);
});
