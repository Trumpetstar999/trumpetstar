...
export function MobileAudioPlayer() {
  ...
  return (
    <div className="flex flex-col h-full" style={{ background: 'rgba(10,20,50,0.92)', borderRadius: '1rem' }}>
      ...
      {/* ── Player bottom panel ── */}
      <div className="flex-shrink-0 px-4 pb-4 pt-3 space-y-3" style={{ borderTop: '1px solid rgba(255,255,255,0.08)' }}>
        ...
        <div className="flex items-center justify-center gap-5">
          ...
          <button
            ...
            style={{ background: 'linear-gradient(135deg, hsl(212 100% 56%), hsl(218 88% 46%))', color: 'white', boxShadow: '0 4px 20px rgba(30,134,255,0.5)' }}
          >
            {player.isPlaying
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1 space-y-1">
            ...
            <input
              ...
              className="w-full h-1.5 rounded-full appearance-none cursor-pointer range-thumb-white"
              style={{ background: `linear-gradient(to right, hsl(212 100% 56%) ${(player.tempo - 50) / 100 * 100}%, rgba(255,255,255,0.15) ${(player.tempo - 50) / 100 * 100}%)` }}
            />
          </div>
          {/* Reset tempo */}
          {player.tempo !== 100 && (
